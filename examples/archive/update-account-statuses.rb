...
puts "Attempting update account statuses request with client_id: #{client_id} and secret: #{client_secret}."
...
stub2 = Happyco::Manage::AccountProvisioning::V1::AccountProvisioningService::Stub.new(host, credentials, timeout: 30)
request2 = Happyco::Manage::AccountProvisioning::V1::UpdateAccountStatusesRequest.new(
  account_ids: [response.accounts.first.id],
  active: false
)
response2 = stub2.update_account_statuses(request2)
